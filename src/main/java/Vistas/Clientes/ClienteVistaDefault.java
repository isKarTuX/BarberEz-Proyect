...
public class ClienteVistaDefault extends javax.swing.JFrame {

    
    public ClienteVistaDefault() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel1.add(btnVerCitas, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 320, 180, 70));
        ...
        jPanel1.add(btnHistorialCitas, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 400, 180, 70));

        btnAgendarCita.setFont(new java.awt.Font("Montserrat ExtraBold", 1, 14)); // NOI18N
        ...
        btnAgendarCita.setIcon(new javax.swing.ImageIcon( "src\\main\\java\\Imagenes\\Cliente\\agenda.png"));
        btnAgendarCita.setText("Agendar Citas");
        btnAgendarCita.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        jPanel1.add(btnAgendarCita, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 240, 180, 70));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ClienteVistaDefault.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ClienteVistaDefault().setVisible(true);
            }
        });
    }
    ...
    public javax.swing.JLabel btnAgendarCita;
