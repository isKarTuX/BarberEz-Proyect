...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        bg.add(ver, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 300, 50, 50));
        ...
        bg.add(ocultar, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 300, 50, 50));
        ...
        favicon.setFont(new java.awt.Font("Montserrat Black", 1, 24)); // NOI18N
        favicon.setIcon(new javax.swing.ImageIcon( "src\\main\\java\\Imagenes\\faro.png"));
        favicon.setText("BARBER EZ");
        ...
        bg.add(userTxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 240, 320, 30));

        jSeparator1.setForeground(new java.awt.Color(0, 0, 0));
        bg.add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 270, 320, 20));
        ...
        bg.add(passTxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 320, 280, 30));

        jSeparator2.setForeground(new java.awt.Color(0, 0, 0));
        bg.add(jSeparator2, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 350, 280, 20));

        SignUpBtn.setBackground(new java.awt.Color(3, 96, 231));
        ...
        loginBtn.setBackground(new java.awt.Color(252, 64, 53));

        loginBtnTxt.setFont(new java.awt.Font("Montserrat ExtraBold", 1, 14)); // NOI18N
    ...
    public javax.swing.JLabel favicon;
